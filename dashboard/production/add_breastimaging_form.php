...
<head>
  ...
  <title>PHMS | Breast Imaging Reports Form </title>
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Welcome to Insert Breast Imaging Reports Form<small>Add your reports here. &nbsp</small></h2>
                  <a href= "breastimaging_type.php" target="_blank"><span class="badge badge-dark">Click here to view the types</span></a>
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="upload_breastimaging.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="item form-group">
                        ...
                        <select class="form-control" id="breast_type" name="breast_type" required>
                            <option value="">Choose option</option>
                            <option>Breast MRI</option>
                            <option>Breast ultrasound</option>
                            <option>C-View synthesized 2D software</option>
                            <option>Digital mammography</option>
                            <option>Ductogram</option>
                            <option>Mammography</option>
                            <option>MRI (breast) core biopsy</option>
                            <option>Stereotactic (breast) core biopsy</option>
                            <option>Tomosynthesis (3D mammography)</option>
                            <option>Ultrasound fine needle aspiration biopsy or core biopsy</option>
                            <option>Wire localization for surgery</option>

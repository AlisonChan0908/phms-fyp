        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Welcome to Insert Basic Imaging Reports Form<small>Add your reports here. &nbsp</small></h2>
                  <a href= "basicimaging_type.php" target="_blank"><span class="badge badge-dark">Click here to view the types</span></a>
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="upload_basicimaging.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="item form-group">
                        ...
                        <select class="form-control" id="basic_type" name="basic_type" required>
                            <option value="">Choose option</option>
                            <option>CT scan (computed axial tomography or CAT scan)</option>
                            <option>CT lung cancer screening</option>
                            <option>Fluoroscopy</option>
                            <option>Magnetic resonance imaging (MRI) scan</option>
                            <option>Ultrasound</option>
                            <option>Virtual colonoscopy</option>

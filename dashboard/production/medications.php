          ...
          <div class="">
            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Record Your Medications Now<small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="add_med_form.php">Add medication</a>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
                        ...
                        $sql = "SELECT * FROM patient_medication WHERE pa_id IN (SELECT pa_id FROM users WHERE username = '$username' ORDER BY pa_med_startd)";
                        if($result = mysqli_query($link, $sql)){
                            if(mysqli_num_rows($result) > 0){
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . $row['pa_med_name'] . "</td>";
                                    echo "<td>" . $row['pa_med_dosage'] . "</td>";
                                    echo "<td>" . $row['pa_med_unit'] . "</td>";                                   
                                    echo "<td>" . $row['pa_med_freq'] . "</td>";
                                    echo "<td>" . $row['pa_med_time'] . "</td>";
                                    echo "<td>" . $row['pa_med_routes'] . "</td>";
                                    echo "<td>" . $row['pa_med_startd'] . "</td>";
                                    echo "<td>" . $row['pa_med_endd'] . "</td>";
                                    echo "<td>" . $row['pa_med_purpose'] . "</td>";
                                    echo "<td>" . $row['pa_med_presby'] . "</td>";                                 
                                    echo "<td>" . $row['pa_med_notes'] . "</td>";

                                    ?>
                                    <!-- Edit Button -->
                                    <td><a href="edit_medications.php?edit_id=<?php echo $row['id']; ?>" alt="edit" >Edit</a></td>
                                    <!-- Delete Button -->
                                            ...
                                            window.location.href='deletemedications.php?del_id=' +delid+'';
                                            return true;
                                            }
                                            } 
                                            </script>

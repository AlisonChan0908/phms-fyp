              ...
              if (isset($_POST["submit"]) && !empty($_FILES["file"]["name"])) {
                ...
                if (in_array($fileType, $allowTypes)) {
                  ...
                  if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)) {
                    ...
                    $ir_type = $_POST['ir_type'];

                    $insert = $con->query("INSERT into ir_imaging (pa_id, file_name, selfdeclared_name, file_description, ir_type, uploaded_on) VALUES ($pa_id, '" . $fileName . "', '$inputtedFileName', '$description', '$ir_type', NOW())")  or die($con->error);

...
$sql = "SELECT * FROM patient_past_illnesses WHERE id =" .$_GET['edit_id'];
...
$illness_fo = $_POST['illness_fo'];


$update = "UPDATE patient_past_illnesses SET illness_name='$illness_name', illness_duration='$illness_duration',illness_fo='$illness_fo'
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Past Illnesses Edit Form<small>Edit your past illnesses record</small></h2>
...
<a href="pastill.php"><button type="button" value="button">Cancel</button></a>
</form>
<!-- Alert for Updating -->
<script>
function update(){

...
<html lang="en">
  <head>
    ...
    <title>PHMS | Family Disease</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Family Disease <small></small></h3>
              </div>
            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Record Your Family Disease Now<small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="add_familyd_form.php">Add family disease</a>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
                        ...
                        $sql = "SELECT * FROM patient_family_disease WHERE pa_id IN (SELECT pa_id FROM users WHERE username = '$username' ORDER BY fam_disease_startd)";
                        ...
                        if($result = mysqli_query($link, $sql)){
                            if(mysqli_num_rows($result) > 0){
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . $row['fam_disease_name'] . "</td>";
                                    echo "<td>" . $row['fam_disease_startd'] . "</td>";
                                    echo "<td>" . $row['fam_disease_endd'] . "</td>";
                                    echo "<td>" . $row['fam_disease_duration'] . "</td>";
                                   ;
                                    
                                   ?>
                                   <!-- Edit Button -->
                                   <td><a href="edit_familyd.php?edit_id=<?php echo $row['id']; ?>" alt="edit" >Edit</a></td>
                                   <!-- Delete Button -->
                                           ...
                                           window.location.href='deletefamilyd.php?del_id=' +delid+'';
                                           return true;
                                           }
                                           } 
                                           </script>

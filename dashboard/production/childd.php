...
<html lang="en">
  <head>
    ...
    <title>PHMS | Child Disease</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Child Disease <small></small></h3>
              </div>
            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Record Your Child Disease Now<small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="add_childd_form.php">Add child disease</a>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
                        ...
                        $sql = "SELECT * FROM patient_child_disease WHERE pa_id IN (SELECT pa_id FROM users WHERE username = '$username' ORDER BY child_disease_startd)";
                        ...
                        if($result = mysqli_query($link, $sql)){
                            if(mysqli_num_rows($result) > 0){
                                ...
                                //    echo "<td>" . $row['child_disease_duration'] . "</td>";
                                    ...
                                    ?>
                                     <!-- Edit Button -->
                                     <td><a href="edit_childd.php?edit_id=<?php echo $row['id']; ?>" alt="edit" >Edit</a></td>
                                    <!-- Delete Button -->
                                            ...
                                            window.location.href='deletechildd.php?del_id=' +delid+'';
                                            return true;
                                            }
                                            } 
                                            </script>

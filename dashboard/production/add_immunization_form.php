...
<html lang="en">
  <head>
    ...
    <title>PHMS | Immunization Form </title>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Immunization Input Form<small>Add your immunizations</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="insert_immunization.php">
                        

                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Date of Received <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="pa_immu_date" name="pa_immu_date" required="required" class="form-control" pattern="^(([0-9])|([0-2][0-9])|([3][0-1]))\-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\-\d{4}$" placeholder="dd-mon-yyyy">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Immunization<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="pa_immu_name" name="pa_immu_name" required="required" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Where on the Body Part</label>
                        <div class="col-md-6 col-sm-6 ">
                          
                        <select class="form-control" id="pa_immu_bodypart" name="pa_immu_bodypart" required>
                            <option value="">Choose option</option>
                            <option>Oral (given by mouth)</option>
                            <option>Intradermal (ID) - Outer upper right arm</option>
                            <option>Subcutaneous (SC) - Outer upper arm</option>
                            <option>Intramuscular (IM) - Outer left upper thigh</option>
                            <option>Intramuscular (IM) - Outer upper arm</option>
                            <option>	Intramuscular (IM) - Outer right upper thigh</option>
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Dose Sequence<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="pa_immu_dose" name="pa_immu_dose" required="required" class="form-control">
                          
                        </div>
                      </div>

                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Vaccinator<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="vaccinator" name="vaccinator" required="required" class="form-control">

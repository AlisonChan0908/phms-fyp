...
<head>
  ...
  <title>PHMS | Basic Imaging Reports Form </title>
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Welcome to Insert Nuclear Imaging Reports Form<small>Add your reports here. &nbsp</small></h2>
                  <a href= "nuclearimaging_type.php" target="_blank"><span class="badge badge-dark">Click here to view the types</span></a>
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="upload_nuclearimaging.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="item form-group">
                        ...
                        <select class="form-control" id="nuclear_type" name="nuclear_type" required>
                            <option value="">Choose option</option>
                            <option>Bone density scan</option>
                            <option>Cardiac PET perfusion</option>
                            <option>Cardiac PET sarcoid</option>
                            <option>Cardiac PET viability</option>
                            <option>Cardiac SPECT perfusion</option>
                            <option>PET/CT scanning</option>                    

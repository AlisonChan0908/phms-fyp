...
<html lang="en">
  <head>
	...
	<link rel="icon" href="images/profile2.png" type="image/ico" />

    <title>Taro | Homepage</title>
            ...
            <br />
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-share-alt"></i> Sharing <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.php">General Form</a></li>
                      <li><a href="form_advanced.php">Advanced Components</a></li>
                      <li><a href="form_validation.php">Form Validation</a></li>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  ...
                  Are you sure you want to delete account? If YES, proceed to click the delete button. 
                  <button type="button" class="btn btn-danger" onclick="window.location.href = 'deleteacc.php';">Delete Account</button>
                  </div>
                </div>
              </div>
            </div>

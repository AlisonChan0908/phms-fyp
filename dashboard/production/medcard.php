          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Medical Card <small></small></h3>
              </div>
            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Store your medical card information here (if have any)<small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="add_medcard_form.php">Add medical card</a>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <th>Medical Card Product Name</th>
                          <th>Type</th>
                          <th>Cover until Age</th>
                          <th>Annual Limit (AL)</th>
                          <th>Lifetime Limit(LL)</th>
                          <th>Claim Frequency (projected)</th>
                      ...
                      <?php
                        ...
                        $sql = "SELECT * FROM medcard WHERE pa_id IN (SELECT pa_id FROM users WHERE username = '$username')";
                        ...
                        if($result = mysqli_query($link, $sql)){
                            if(mysqli_num_rows($result) > 0){
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . $row['medcard_productname'] . "</td>";
                                    echo "<td>" . $row['medcard_type'] . "</td>";
                                    echo "<td>" . $row['cover_until_age'] . "</td>";
                                    echo "<td>" . $row['annual_limit'] . "</td>";
                                    echo "<td>" . $row['lifetime_limit'] . "</td>";
                                    echo "<td>" . $row['claim_frequency'] . "</td>";
                                    echo "<td>" . $row['subs_date'] . "</td>";
                                    echo "<td>" . $row['exp_date'] . "</td>";
                                    ?>
                                    <!-- Edit Button -->
                                    <td><a href="edit_medcard.php?edit_id=<?php echo $row['id']; ?>" alt="edit" >Edit</a></td>
                                    <!-- Delete Button -->
                                            ...
                                            window.location.href='deletemedcard.php?del_id=' +delid+'';
                                            return true;
                                            }
                                            } 
                                            </script>

...
$sql = "SELECT * FROM patient_hospitalization WHERE id =" .$_GET['edit_id'];
$result = mysqli_query($con, $sql) or die( mysqli_error($con));
$row = mysqli_fetch_array($result);
}
//Update Information
if(isset($_POST['btn-update'])){
$hos_start_date = $_POST['hos_start_date'];
$hos_end_date = $_POST['hos_end_date'];
$hos_reason = $_POST['hos_reason'];
$hos_duration = $_POST['hos_duration'];
$hos_venue = $_POST['hos_venue'];

$hos_duration = abs($hos_start_date - $hos_end_date); 

$update = "UPDATE patient_hospitalization SET hos_start_date='$hos_start_date', hos_end_date='$hos_end_date',hos_reason='$hos_reason',hos_duration='$hos_duration',hos_venue='$hos_venue'
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Hospitalization Edit Form<small>Edit your hospitalization record</small></h2>
...
<a href="hospitalization.php"><button type="button" value="button">Cancel</button></a>
</form>
<!-- Alert for Updating -->
<script>
function update(){

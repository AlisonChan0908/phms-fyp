...
<html lang="en">
  <head>
    ...
    <title>PHMS | Hospitalization Form </title>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Hospitalization Input Form<small>Add your hospitalization records</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="insert_hospitalization.php">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Reason of hospitalization<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="hos_reason" name="hos_reason"  class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Hospital Name<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="hos_venue" name="hos_venue" required="required" class="form-control">

...
$sql = "SELECT * FROM phys_schedule WHERE id =" .$_GET['edit_id'];
...
$schedule_starttime = $_POST['schedule_starttime'];
$schedule_endtime = $_POST['schedule_endtime'];
$phys_avail = $_POST['phys_avail'];


$update = "UPDATE phys_schedule SET schedule_date='$schedule_date', schedule_day='$schedule_day',schedule_starttime='$schedule_starttime',schedule_endtime='$schedule_endtime',phys_avail='$phys_avail'
...
<html lang="en">
  <head>
    ...
    <title>PHMS | Schedule Edit Form </title>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Schedule Edit Form<small>Edit your schedule</small></h2>
...
<label>Start Time:<span class="required"></span></label><input type="time" name="schedule_starttime"  required="required" value="<?php echo $row['schedule_starttime']; ?>"><br/><br/>
<label>End Time:<span class="required"></span></label><input type="time" name="schedule_endtime"  required="required" value="<?php echo $row['schedule_endtime']; ?>"><br/><br/>

<label for="phys_avail">Availability:</label> <div>
...
<a href="phys_schedule.php"><button type="button" value="button">Cancel</button></a>
</form>
<!-- Alert for Updating -->
<script>
function update(){

...
$sql = "SELECT * FROM patient_height WHERE id =" .$_GET['edit_id'];
$result = mysqli_query($con, $sql) or die( mysqli_error($con));
$row = mysqli_fetch_array($result);
}
//Update Information
if(isset($_POST['btn-update'])){
$pa_height_date = $_POST['pa_height_date'];
$pa_height_time = $_POST['pa_height_time'];
$pa_height = $_POST['pa_height'];


$update = "UPDATE patient_height SET pa_height_date='$pa_height_date', pa_height_time='$pa_height_time',pa_height='$pa_height'
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Height Edit Form<small>Edit your height record</small></h2>
...
<label>Date:<span class="required"></span></label><input type="text" name="pa_height_date"  required="required" pattern="^(([0-9])|([0-2][0-9])|([3][0-1]))\-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\-\d{4}$" placeholder="dd-mon-yyyy" value="<?php echo $row['pa_height_date']; ?>"><br/><br/>
...
<a href="edit_heightpage.php"><button type="button" value="button">Cancel</button></a>
</form>
<!-- Alert for Updating -->
<script>
function update(){

...
$sql = "SELECT * FROM patient_surgeries WHERE id =" .$_GET['edit_id'];
...
$surgery_hospital = $_POST['surgery_hospital'];
$surgeon_name = $_POST['surgeon_name'];


$update = "UPDATE patient_surgeries SET pro_name='$pro_name', surgery_date='$surgery_date',surgery_hospital='$surgery_hospital',surgeon_name='$surgeon_name'
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Surgery Edit Form<small>Edit your surgery record</small></h2>
...
<a href="surgery.php"><button type="button" value="button">Cancel</button></a>
</form>
<!-- Alert for Updating -->
<script>
function update(){

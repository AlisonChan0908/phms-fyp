...
$pa_id = $_SESSION['pa_id'];
	...
	$sql = "SELECT * FROM patient_height WHERE pa_id = $pa_id ORDER BY pa_height_date ASC";
    $result = mysqli_query($con, $sql);

	//loop through the returned data
	while ($row = mysqli_fetch_array($result)) {
        $pa_height_date = $pa_height_date . '"'. $row['pa_height_date'].'",';
		$pa_height = $pa_height . '"'. $row['pa_height'].'",';
	}

	$pa_height = trim($pa_height,",");
...
<div class="container">	
			...
			<script>
        		...
        		type: 'line',
		        data: {
		            labels: [<?php echo $pa_height_date; ?>],// you defined here so show there
		            datasets: 
		            [{
		                label: 'Height',
		                data: [<?php echo $pa_height; ?>],

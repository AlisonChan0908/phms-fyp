          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Cholesterol Input Form<small>Add your latest cholesterol level</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="insert_cholesterol.php">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="time" id="pa_cho_time" name="pa_cho_time" required="required" class="form-control">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">LDL (mg/dL) </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input id="pa_ldl" class="form-control" type="number" name="pa_ldl" >
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">HDL (mg/dL) </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input id="pa_hdl" class="form-control" type="number" name="pa_hdl" >
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Triglycerides (mg/dL)</label>
                        <div class="col-md-6 col-sm-6 ">
                          <input id="pa_trigly" class="form-control" type="number" name="pa_trigly" >
                        </div>
                      </div>

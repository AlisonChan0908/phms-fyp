...
<html lang="en">
  <head>
    ...
    <title>Taro | Blood Pressure Form </title>
...
<label>Date:<span class="required"></span></label><input type="text" name="pa_bp_date"  required="required"  pattern="^(([0-9])|([0-2][0-9])|([3][0-1]))\-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\-\d{4}$" value="<?php echo $row['pa_bp_date']; ?>"><br/><br/>

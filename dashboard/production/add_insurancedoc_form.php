...
<head>
  ...
  <title>PHMS | Insurance Document Form </title>
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Welcome to Insert Documents Form<small>Add your documents here.</small></h2>
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="upload_insurancedoc.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="file_description" name="file_description" required="required" class="form-control">
                      </div>
                    </div>

          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Blood Pressure Input Form<small>Add your latest blood pressure record</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="insert_bloodpressure.php">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" pattern="^(([0-9])|([0-2][0-9])|([3][0-1]))\-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\-\d{4}$" placeholder="dd-mon-yyyy" id="pa_bp_date" name="pa_bp_date" required="required" class="form-control">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="time" id="pa_bp_time" name="pa_bp_time" required="required" class="form-control">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Systolic (in mmHg) </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input id="pa_systolic" class="form-control" type="number" name="pa_systolic" >
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Diastolic (in mmHg) </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input id="pa_diastolic" class="form-control" type="number" name="pa_diastolic" >
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Pulse (in beats per minute) </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input id="pa_pulse" class="form-control" type="number" name="pa_pulse" required="required">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Irregular Heartbeat </label>
                        <div class="col-md-6 col-sm-6 ">

              ...
              if (isset($_POST["submit"]) && !empty($_FILES["file"]["name"])) {
                ...
                if (in_array($fileType, $allowTypes)) {
                  ...
                  if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)) {
                    ...
                    $insert = $con->query("INSERT into insurance_doc (pa_id, file_name, selfdeclared_name, file_description, uploaded_on) VALUES ($pa_id, '" . $fileName . "', '$inputtedFileName', '$description', NOW())")  or die($con->error);

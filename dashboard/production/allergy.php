          ...
          <div class="">
            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Record Your Allergies Now<small></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
                        ...
                        $sql = "SELECT * FROM patient_allergy WHERE pa_id IN (SELECT pa_id FROM users WHERE username = '$username' ORDER BY pa_allergy_fo)";
                        ...
                        if($result = mysqli_query($link, $sql)){
                            if(mysqli_num_rows($result) > 0){
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . $row['pa_allergy_name'] . "</td>";
                                    echo "<td>" . $row['pa_allergy_type'] . "</td>";
                                    echo "<td>" . $row['pa_allergy_reaction'] . "</td>";
                                    echo "<td>" . $row['pa_allergy_tx'] . "</td>";
                                    echo "<td>" . $row['pa_allergy_fo'] . "</td>";
                                    echo "<td>" . $row['pa_allergy_notes'] . "</td>";
                                    
                                    
                                    ?>
                                     <!-- Edit Button -->
                                     <td><a href="edit_allergy.php?edit_id=<?php echo $row['id']; ?>" alt="edit" >Edit</a></td>

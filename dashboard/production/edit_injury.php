...
$sql = "SELECT * FROM patient_injury WHERE id =" .$_GET['edit_id'];
...
$injury_start_date = $_POST['injury_start_date'];
$injury_end_date = $_POST['injury_end_date'];
$injury_trt_venue = $_POST['injury_trt_venue'];
$injury_rec_duration = $_POST['injury_rec_duration'];

$injury_rec_duration = abs($injury_start_date - $injury_end_date);  

$update = "UPDATE patient_injury SET injury_name='$injury_name', injury_start_date='$injury_start_date',injury_end_date='$injury_end_date',injury_trt_venue='$injury_trt_venue',injury_rec_duration='$injury_rec_duration'
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Injury Edit Form<small>Edit your injury record</small></h2>
...
<a href="injury.php"><button type="button" value="button">Cancel</button></a>
</form>
<!-- Alert for Updating -->
<script>
function update(){

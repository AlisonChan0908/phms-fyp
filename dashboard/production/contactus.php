          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Got a Question?<small>Contact PHMS. Our help centre team is always ready to help and answer your question.</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="insert_contactus.php">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="patient_fullname" name="patient_fullname" required="required" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="email" id="patient_email" name="patient_email" required="required" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="tel" id="patient_contactnumber" name="patient_contactnumber" required="required" class="form-control">
                        </div>
                      </div>
                   
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Message<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                        <textarea class="resizable_textarea form-control" id="pa_message" name="pa_message" placeholder="Add your message here."></textarea>

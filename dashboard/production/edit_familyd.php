...
$fam_disease_name = $_POST['fam_disease_name'];
$fam_disease_startd = $_POST['fam_disease_startd'];
$fam_disease_endd = $_POST['fam_disease_endd'];
$fam_disease_duration = $_POST['fam_disease_duration'];

$fam_disease_duration = abs($fam_disease_startd - $fam_disease_endd);

$update = "UPDATE patient_family_disease SET fam_disease_name='$fam_disease_name', fam_disease_startd='$fam_disease_startd',fam_disease_endd='$fam_disease_endd',fam_disease_duration='$fam_disease_duration'
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Family Disease Edit Form<small>Edit your family disease record</small></h2>
...
<label>Disease Name:<span class="required"></span></label><input type="text" name="fam_disease_name"  required="required" ><br/><br/>

       ...
       <div class="top_nav">
        ...
        <div class="right_col" role="main">
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>View your appointments here</h3>
                        </div>
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Bookings <small>View your bookings here.</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <thead>
                      ...
                      <?php
                        ...
                        $sql = "SELECT * FROM booking WHERE pa_id IN (SELECT pa_id FROM users WHERE username = '$username')";

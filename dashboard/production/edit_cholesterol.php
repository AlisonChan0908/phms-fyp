...
$sql = "SELECT * FROM patient_cholesterol WHERE id =" .$_GET['edit_id'];
$result = mysqli_query($con, $sql) or die( mysqli_error($con));
$row = mysqli_fetch_array($result);
}
//Update Information
if(isset($_POST['btn-update'])){
$pa_cho_date = $_POST['pa_cho_date'];
$pa_cho_time = $_POST['pa_cho_time'];
$pa_ldl = $_POST['pa_ldl'];
$pa_hdl = $_POST['pa_hdl'];
$pa_trigly = $_POST['pa_trigly'];
$pa_total_cho = $_POST['pa_total_cho'];

$percentage = 0.2;
$new_pa_trigly = ($percentage * $pa_trigly);
$pa_total_cho = $pa_ldl + $pa_hdl + $new_pa_trigly;

$update = "UPDATE patient_cholesterol SET pa_cho_date='$pa_cho_date', pa_cho_time='$pa_cho_time',pa_ldl='$pa_ldl',pa_hdl='$pa_hdl',pa_trigly='$pa_trigly',pa_total_cho='$pa_total_cho'
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Cholesterol Edit Form<small>Edit your cholesterol record</small></h2>
...
<label>Date:<span class="required"></span></label><input type="text" name="pa_bp_date"  required="required"  pattern="^(([0-9])|([0-2][0-9])|([3][0-1]))\-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\-\d{4}$" placeholder="dd-mon-yyyy" name="pa_cho_date"  required="required" value="<?php echo $row['pa_cho_date']; ?>"><br/><br/>
<label>Time:<span class="required"></span></label><input type="time" name="pa_cho_time"  required="required" value="<?php echo $row['pa_cho_time']; ?>"><br/><br/>
<label>LDL (mg/dL):<span class="required"></span></label><input type="number" name="pa_ldl"  required="required" value="<?php echo $row['pa_ldl']; ?>"><br/><br/>
<label>HDL (mg/dL):<span class="required"></span></label><input type="number" name="pa_hdl"  required="required" value="<?php echo $row['pa_hdl']; ?>"><br/><br/>
<label>Triglycerides (mg/dL):<span class="required"></span></label><input type="number" name="pa_trigly"  required="required" value="<?php echo $row['pa_trigly']; ?>"><br/><br/>



<button type="submit" name="btn-update" id="btn-update" onClick="update()"><strong>Update</strong></button>
<a href="edit_cholesterolpage.php"><button type="button" value="button">Cancel</button></a>
</form>
<!-- Alert for Updating -->
<script>
function update(){

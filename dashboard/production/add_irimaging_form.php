...
<head>
  ...
  <title>PHMS | IR Imaging Reports Form </title>
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Welcome to Insert IR Imaging Reports Form<small>Add your reports here. &nbsp</small></h2>
                  <a href= "irimaging_type.php" target="_blank"><span class="badge badge-dark">Click here to view the types</span></a>
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="upload_irimaging.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="item form-group">
                        ...
                        <select class="form-control" id="ir_type" name="ir_type" required>
                            <option value="">Choose option</option>
                            <option>Biopsy</option>
                            <option>Chemoembolization</option>
                            <option>Fallopian tube recanalization</option>
                            <option>Radioembolization</option>
                            <option>Tumor ablation therapies</option>
                            <option>UFE (Uterine fibroid embolization)</option>

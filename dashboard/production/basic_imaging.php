        ...
        <div class="">
          <div class="page-title">
            ...
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Basic Imaging Reports<small></small></h2>
                  <ul class="nav navbar-right panel_toolbox">
                    ...
                    <li class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="add_basicimaging_form.php">Add reports</a>
                    ...
                    <div class="col-sm-12">
                      <div class="card-box table-responsive">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                          ...
                          $sql="SELECT * FROM basic_imaging WHERE pa_id IN (SELECT pa_id FROM users WHERE username = '$username' ORDER BY uploaded_on)";
                          $result = mysqli_query($link, $sql);
                          while($row=mysqli_fetch_array($result))
                          {
                            $uploaded_on1= date('d/m/Y',strtotime($uploaded_on));
                            ?>
                          ...
                          <tbody>
                              ...
                              <td><?php echo $row['uploaded_on1'] ?></td>
                                 ...
                                 <td><input type="button" onClick="deleteme(<?php echo $row['id']; ?>)" name="Delete" value="Delete"></td>
                                             ...
                                             window.location.href='delete_basicimaging.php?del_id=' +delid+'';
                                             return true;
                                             }
                                             } 
                                  </script>

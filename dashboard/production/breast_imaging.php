...
<head>
  ...
  <title>PHMS | Breast Imaging Reports </title>
        ...
        <div class="">
          <div class="page-title">
            ...
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Breast Imaging services and Image-Guided Breast procedures<small></small></h2>
                  <ul class="nav navbar-right panel_toolbox">
                    ...
                    <li class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="add_breastimaging_form.php">Add reports</a>
                    ...
                    <div class="col-sm-12">
                      <div class="card-box table-responsive">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                          ...
                          $sql="SELECT * FROM breast_imaging WHERE pa_id IN (SELECT pa_id FROM users WHERE username = '$username' ORDER BY uploaded_on)";
                          ...
                          <tbody>
                              ...
                              <td><?php echo $row['breast_type'] ?></td>
                              ...
                              <td><?php echo $row['uploaded_on'] ?></td>
                                 ...
                                 <td><input type="button" onClick="deleteme(<?php echo $row['id']; ?>)" name="Delete" value="Delete"></td>
                                             ...
                                             window.location.href='delete_breastimaging.php?del_id=' +delid+'';
                                             return true;
                                             }
                                             } 
                                  </script>

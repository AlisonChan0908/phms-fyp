...
<html lang="en">
  <head>
    ...
    <title>PHMS | Health History</title>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Select Your Health History</h2>
                  ...
                  <div class="x_content">
                  <a href="immunization.php"><button type="button" class="btn btn-link">Immunization</button></a> </br>
                  <a href="childd.php"><button type="button" class="btn btn-link">Child Disease</button></a> </br>
                  <a href="familyd.php"><button type="button" class="btn btn-link">Family Disease</button></a> </br>
                  <a href="pastill.php"><button type="button" class="btn btn-link">Past Illnesses</button></a> </br>
                  <a href="hospitalization.php"><button type="button" class="btn btn-link">Hospitalization</button></a> </br>
                  <a href="injury.php"><button type="button" class="btn btn-link">Injury</button></a> </br>
                  <a href="surgery.php"><button type="button" class="btn btn-link">Surgery</button></a> </br>
                  </div>
                </div>
              </div>
            </div>

...
<html lang="en">
  <head>
    ...
    <title>PHMS | Blood Glucose</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Blood Glucose <small></small></h3>
              </div>
  ...
  close[i].onclick = function(){
    ...
    setTimeout(function(){ div.style.display = "none"; }, 600);
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Record Your Blood Glucose Now<small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="add_latest_bloodglucose_form.php">Add blood glucose</a>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
                       ...
                       $sql = "SELECT * FROM patient_bg WHERE pa_id IN (SELECT pa_id FROM users WHERE username = '$username' ORDER BY pa_bg_date)";
                       ...
                       if($result = mysqli_query($link, $sql)){
                           if(mysqli_num_rows($result) > 0){
                               ...
                               while ($row = $result->fetch_assoc()) {
                                   ...
                                   echo "<td>" . $row['pa_diabetic'] . "</td>";
                                    ?>
                                     <!-- Edit Button -->
                                     <td><a href="edit_bg.php?edit_id=<?php echo $row['id']; ?>" alt="edit" >Edit</a></td>
                                   <!-- Delete Button -->
                                           ...
                                           window.location.href='deletebg.php?del_id=' +delid+'';
                                           return true;
                                           }
                                           } 
                                           </script>

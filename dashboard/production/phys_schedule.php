                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="insert_schedule.php">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="schedule_date" name="schedule_date" required="required" class="form-control" pattern="^(([0-9])|([0-2][0-9])|([3][0-1]))\-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\-\d{4}$" placeholder="dd-mon-yyyy">
                        </div>
                      </div>

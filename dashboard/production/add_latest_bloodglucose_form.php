          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Blood Glucose Input Form<small>Add your latest blood glucose record</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="insert_bloodglucose.php">
                      ...
                      <div class="item form-group">
                        ...
                        <input type="text" pattern="^(([0-9])|([0-2][0-9])|([3][0-1]))\-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\-\d{4}$" placeholder="dd-mon-yyyy" id="pa_bg_date" name="pa_bg_date" required="required" class="form-control">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="time" id="pa_bg_time" name="pa_bg_time" required="required" class="form-control">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Sugar Concentration (mg/dL) <span class="required"></span></label>
                        <div class="col-md-6 col-sm-6 ">
                          <input id="pa_sugarc" class="form-control" type="number" name="pa_sugarc" required="required">
                        </div>
                      </div>
                  
                     
                      <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Measured</label>
                        <div class="col-md-6 col-sm-6 ">
                          
                        <select class="form-control" id="pa_measuredt" name="pa_measuredt" required>
                      ...
                      <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Do you have diabetes?</label>
                        <div class="col-md-6 col-sm-6 ">
                          
                        <select class="form-control" id="pa_diabetic" name="pa_diabetic" required>
                            <option value="">Choose option</option>
                            <option>Yes</option>
                            <option>No</option>

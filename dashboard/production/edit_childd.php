...
$sql = "SELECT * FROM patient_child_disease WHERE id =" .$_GET['edit_id'];
$result = mysqli_query($con, $sql) or die( mysqli_error($con));
$row = mysqli_fetch_array($result);
}
//Update Information
if(isset($_POST['btn-update'])){
$child_disease_name = $_POST['child_disease_name'];
$child_disease_startd = $_POST['child_disease_startd'];
$child_disease_endd = $_POST['child_disease_endd'];
$child_disease_duration = $_POST['child_disease_duration'];

$child_disease_duration = abs($child_disease_startd - $child_disease_endd);  

$update = "UPDATE patient_child_disease SET child_disease_name='$child_disease_name', child_disease_startd='$child_disease_startd',child_disease_endd='$child_disease_endd',child_disease_duration='$child_disease_duration'
...
<html lang="en">
  <head>
    ...
    <title>PHMS | Child Disease Form </title>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Child Disease Edit Form<small>Edit your child disease record</small></h2>

                  ...
                  <div class="x_content">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="date" id="pa_med_startd" name="pa_med_startd" required="required" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="date" id="pa_med_endd" name="pa_med_endd"  class="form-control">
                        </div>
                      </div>

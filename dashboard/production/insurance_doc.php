...
<head>
  ...
  <title>PHMS | Insurance Documents </title>
        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>Insurance Documents <small></small></h3>
            </div>
            ...
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Insert Your Documents Here<small></small></h2>
                  <ul class="nav navbar-right panel_toolbox">
                    ...
                    <li class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="add_insurancedoc_form.php">Add documents</a>
                          ...
                          <tbody>
                              ...
                              <td><?php echo $row['uploaded_on'] ?></td>
                                 ...
                                 <td><input type="button" onClick="deleteme(<?php echo $row['id']; ?>)" name="Delete" value="Delete"></td>
                                             ...
                                             window.location.href='deleteinsurancedoc.php?del_id=' +delid+'';
                                             return true;
                                             }
                                             } 
                                  </script>

...
<html lang="en">
  <head>
    ...
    <title>PHMS | Past Illnesses</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Past Illnesses <small></small></h3>
              </div>
            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Record Your Past Illnesses Now<small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="add_pastill_form.php">Add Past Illness</a>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
                        ...
                        $sql = "SELECT * FROM patient_past_illnesses WHERE pa_id IN (SELECT pa_id FROM users WHERE username = '$username' ORDER BY illness_fo)";
                        ...
                        if($result = mysqli_query($link, $sql)){
                            if(mysqli_num_rows($result) > 0){
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . $row['illness_name'] . "</td>";
                                    echo "<td>" . $row['illness_duration'] . "</td>";
                                    echo "<td>" . $row['illness_fo'] . "</td>";
                                    
                                   ;
                                   ?>
                                    <!-- Edit Button -->
                                    <td><a href="edit_pastill.php?edit_id=<?php echo $row['id']; ?>" alt="edit" >Edit</a></td>
                                   <!-- Delete Button -->
                                           ...
                                           window.location.href='deletepastill.php?del_id=' +delid+'';
                                           return true;
                                           }
                                           } 
                                           </script>

                  ...
                  <h2>Record Your Insurance<small> or  <a href = "insurance_doc.php">Click here to store your insurance documents</a></small></h2>
                      ...
                      <li class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="add_insurance_form.php">Add insurance</a>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
                        ...
                        $sql = "SELECT * FROM insurance WHERE pa_id IN (SELECT pa_id FROM users WHERE username = '$username')";
                        ...
                        if($result = mysqli_query($link, $sql)){
                            if(mysqli_num_rows($result) > 0){
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . $row['insur_prov_name'] . "</td>";
                                    echo "<td>" . $row['insur_plan_code'] . "</td>";
                                    echo "<td>" . $row['insur_plan_name'] . "</td>";
                                    echo "<td>" . $row['insur_subs_date'] . "</td>";
                                    echo "<td>" . $row['insur_exp_date'] . "</td>";
                                    echo "<td>" . $row['insur_coverage_type'] . "</td>";
                                    ?>
                                    <!-- Edit Button -->
                                    <td><a href="edit_insurance.php?edit_id=<?php echo $row['id']; ?>" alt="edit" >Edit</a></td>
                                    <!-- Delete Button -->
                                            ...
                                            window.location.href='deleteinsurance.php?del_id=' +delid+'';
                                            return true;
                                            }
                                            } 
                                            </script>

...
$sql = "SELECT * FROM patient_immu WHERE id =" .$_GET['edit_id'];
$result = mysqli_query($con, $sql) or die( mysqli_error($con));
$row = mysqli_fetch_array($result);
}
//Update Information
if(isset($_POST['btn-update'])){
$pa_immu_date = $_POST['pa_immu_date'];
$pa_immu_name = $_POST['pa_immu_name'];
$pa_immu_bodypart = $_POST['pa_immu_bodypart'];
$pa_immu_dose = $_POST['pa_immu_dose'];
$vaccinator = $_POST['vaccinator'];


$update = "UPDATE patient_immu SET pa_immu_date='$pa_immu_date', pa_immu_name='$pa_immu_name',pa_immu_bodypart='$pa_immu_bodypart',pa_immu_dose='$pa_immu_dose',vaccinator='$vaccinator'
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Immunization Edit Form<small>Edit your immunization record</small></h2>
...
<label>Dose Sequence:<span class="required"></span></label><input type="number" name="pa_immu_dose"  required="required" value="<?php echo $row['pa_immu_dose']; ?>"><br/><br/>
<label>Vaccinator:<span class="required"></span></label><input type="text" name="vaccinator"  required="required" value="<?php echo $row['vaccinator']; ?>"><br/><br/>

<button type="submit" name="btn-update" id="btn-update" onClick="update()"><strong>Update</strong></button>
<a href="immunization.php"><button type="button" value="button">Cancel</button></a>
</form>
<!-- Alert for Updating -->
<script>
function update(){

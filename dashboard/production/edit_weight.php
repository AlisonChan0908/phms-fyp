...
$sql = "SELECT * FROM patient_weight WHERE id =" .$_GET['edit_id'];
$result = mysqli_query($con, $sql) or die( mysqli_error($con));
$row = mysqli_fetch_array($result);
}
//Update Information
if(isset($_POST['btn-update'])){
$pa_weight_date = $_POST['pa_weight_date'];
$pa_weight_time = $_POST['pa_weight_time'];
$pa_weight = $_POST['pa_weight'];


$update = "UPDATE patient_weight SET pa_weight_date='$pa_weight_date', pa_weight_time='$pa_weight_time',pa_weight='$pa_weight'
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Weight Edit Form<small>Edit your weight record</small></h2>
...
<a href="edit_weightpage.php"><button type="button" value="button">Cancel</button></a>
</form>
<!-- Alert for Updating -->
<script>
function update(){

...
$sql = "SELECT * FROM patient_allergy WHERE id =" .$_GET['edit_id'];
$result = mysqli_query($con, $sql) or die( mysqli_error($con));
$row = mysqli_fetch_array($result);
}
//Update Information
if(isset($_POST['btn-update'])){
$pa_allergy_name = $_POST['pa_allergy_name'];
$pa_allergy_type = $_POST['pa_allergy_type'];
$pa_allergy_reaction = $_POST['pa_allergy_reaction'];
$pa_allergy_tx = $_POST['pa_allergy_tx'];
$pa_allergy_fo = $_POST['pa_allergy_fo'];
$pa_allergy_notes = $_POST['pa_allergy_notes'];




$update = "UPDATE patient_allergy SET pa_allergy_name='$pa_allergy_name', pa_allergy_type='$pa_allergy_type',pa_allergy_reaction='$pa_allergy_reaction',pa_allergy_tx='$pa_allergy_tx',pa_allergy_fo='$pa_allergy_fo',pa_allergy_notes='$pa_allergy_notes' 
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Allergy Edit Form<small>Edit your allergy record</small></h2>
...
<label>Name:<span class="required"></span></label><input type="text" name="pa_allergy_name"  required="required" value="<?php echo $row['pa_allergy_name']; ?>"><br/><br/>

<label for="pa_allergy_type">Type:</label> <div>

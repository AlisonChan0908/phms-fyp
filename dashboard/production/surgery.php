          ...
          <div class="">
            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Record Your Surgery History<small></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
                        ...
                        $sql = "SELECT * FROM patient_surgeries WHERE pa_id IN (SELECT pa_id FROM users WHERE username = '$username' ORDER BY surgery_date)";
                        ...
                        if($result = mysqli_query($link, $sql)){
                            if(mysqli_num_rows($result) > 0){
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . $row['surgery_hospital'] . "</td>";
                                   ...
                                   ?>
                                   <!-- Edit Button -->
                                   <td><a href="edit_surgery.php?edit_id=<?php echo $row['id']; ?>" alt="edit" >Edit</a></td>
                                   <!-- Delete Button -->
                                           ...
                                           window.location.href='deletesurgery.php?del_id=' +delid+'';
                                           return true;
                                           }
                                           } 
                                           </script>

          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Blood Pressure <small></small></h3>
              </div>
  ...
  close[i].onclick = function(){
    ...
    setTimeout(function(){ div.style.display = "none"; }, 600);
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Record Your Blood Pressure Now<small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="add_latest_bloodpressure_form.php">Add blood pressure</a>
                        ...
                        if($result = mysqli_query($link, $sql)){
                            if(mysqli_num_rows($result) > 0){
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    ?>
                                     <!-- Edit Button -->
                                     <td><a href="edit_bp.php?edit_id=<?php echo $row['id']; ?>" alt="edit" >Edit</a></td>
                                   <!-- Delete Button -->
                                           ...
                                           window.location.href='deletebp.php?del_id=' +delid+'';
                                           return true;
                                           }
                                           } 
                                           </script>

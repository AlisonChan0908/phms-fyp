              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                                                            ...
                                                            if ($result = mysqli_query($link, $sql)) {
                                                                if (mysqli_num_rows($result) > 0) {
                                                                    ...
                                                                    while ($row = $result->fetch_assoc()) {
                                                                      $pec_firstname=$row['pec_firstname'];
                                                                      $pec_lastname= $row['pec_lastname'];
                                                                      $pec_relationship=$row['pec_relationship'];
                                                                      $pec_house_no= $row['pec_house_no'];
                                                                      $pec_phone_no=$row['pec_phone_no'];
                                                                      $sec_firstname=$row['sec_firstname'];
                                                                      $sec_lastname= $row['sec_lastname'];
                                                                      $sec_relationship=$row['sec_relationship'];
                                                                      $sec_house_no= $row['sec_house_no'];
                                                                      $sec_phone_no=$row['sec_phone_no'];
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="insert_emer_profile.php" >
                    Primary Emergency Contact
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">First Name <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="pec_firstname" name="pec_firstname" required="required" class="form-control" value="<?php echo $pec_firstname; ?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="pec_lastname" name="pec_lastname" required="required" class="form-control" value="<?php echo $pec_lastname; ?>">
                        </div>
                      </div>

                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Relationship <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="pec_relationship" name="pec_relationship" required="required" class="form-control" value="<?php echo $pec_relationship; ?>">
                        </div>
                      </div>

                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">House Telephone No. <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="pec_house_no" name="pec_house_no" required="required" class="form-control" value="<?php echo $pec_house_no; ?>">
                        </div>
                      </div>  
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="pec_phone_no" name="pec_phone_no" required="required" class="form-control" value="<?php echo $pec_phone_no; ?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="sec_firstname" name="sec_firstname" required="required" class="form-control" value="<?php echo $sec_firstname; ?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="sec_lastname" name="sec_lastname" required="required" class="form-control" value="<?php echo $sec_lastname; ?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="sec_relationship" name="sec_relationship" required="required" class="form-control" value="<?php echo $sec_relationship; ?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="sec_house_no" name="sec_house_no" required="required" class="form-control" value="<?php echo $sec_house_no; ?>">
                        </div>
                      </div>  
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="sec_phone_no" name="sec_phone_no" required="required" class="form-control" value="<?php echo $sec_phone_no; ?>">
                        </div>
                      </div>

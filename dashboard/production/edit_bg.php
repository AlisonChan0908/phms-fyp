...
$sql = "SELECT * FROM patient_bg WHERE id =" .$_GET['edit_id'];
$result = mysqli_query($con, $sql) or die( mysqli_error($con));
$row = mysqli_fetch_array($result);
}
//Update Information
if(isset($_POST['btn-update'])){
$pa_bg_date = $_POST['pa_bg_date'];
$pa_bg_time = $_POST['pa_bg_time'];
$pa_sugarc = $_POST['pa_sugarc'];
$pa_measuredt = $_POST['pa_measuredt'];
$pa_diabetic = $_POST['pa_diabetic'];

$update = "UPDATE patient_bg SET pa_bg_date='$pa_bg_date', pa_bg_time='$pa_bg_time',pa_sugarc='$pa_sugarc',pa_measuredt='$pa_measuredt',
pa_diabetic='$pa_diabetic'
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Welcome to Blood Glucose Edit Form<small>Edit your blood glucose record</small></h2>
...
<label>Date:<span class="required"></span></label><input type="date" name="pa_bg_date"  required="required" value="<?php echo $row['pa_bg_date']; ?>"><br/><br/>
...
<label for="pa_diabetic">Diabetic:</label> <div>
...
<a href="edit_bgpage.php"><button type="button" value="button">Cancel</button></a>
</form>
<!-- Alert for Updating -->
<script>
function update(){

  ...
  close[i].onclick = function(){
    ...
    setTimeout(function(){ div.style.display = "none"; }, 600);
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Record Your Cholesterol Now<small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="add_latest_cholesterol_form.php">Add cholesterol</a>
                          ...
                          if(mysqli_num_rows($result) > 0){
                              ...
                              while ($row = $result->fetch_assoc()) {
                                  ...
                                  echo "<td>" . $row['pa_total_cho'] . "</td>";
                                    ...
                                    ?>
                                    <!-- Edit Button -->
                                    <td><a href="edit_cholesterol.php?edit_id=<?php echo $row['id']; ?>" alt="edit" >Edit</a></td>
                                   <!-- Delete Button -->
                                           ...
                                           window.location.href='deletecholesterol.php?del_id=' +delid+'';
                                           return true;
                                           }
                                           } 
                                           </script>

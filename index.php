<?php 
  ...
  if (!isset($_SESSION['username'])) {
  	...
  	header('location: dashboard/production/SignupSignin/signin.php');
  }
  ...
  <div class="content">
    ...
    <?php endif ?>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="dashboard/production/Covid-19/covid19.php">Covid-19</a></li>
                  ...
                  <li><a><i class="fa fa-line-chart"></i> Health Tracking <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dashboard/production/measurements.php">Measurements</a></li>
                  ...
                  <ul class="nav child_menu">
                    <li><a href="dashboard/production/personal_profile.php">Personal Profile</a></li>
                    <li><a href="dashboard/production/health_history.php">Health History</a></li>
                    <li><a href="dashboard/production/allergy.php">Allergy</a></li>
                    <li><a href="dashboard/production/medications.php">Medications</a></li>
                   
                    <li><a>Imaging Reports<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li class="sub_menu"><a href="basic_imaging.php">Basic Imaging</a>
                            </li>
                            <li><a href="dashboard/production/breast_imaging.php">Breast Imaging</a>
                            </li>
                            <li><a href="dashboard/production/ir_imaging.php">Interventional Radiology (IR)</a>
                            </li>
                            <li><a href="dashboard/production/nuclear_imaging.php">Nuclear Imaging</a>
                            </li>
                          </ul>
                        </li>
                    <li><a href="dashboard/production/lab_results.php">Laboratory Test Results</a></li>
                    <li><a href="dashboard/production/files.php"> Miscellaneous Files</a></li>

                  </ul>
                </li>
                  <li><a><i class="fa fa-plus-circle"></i> Emergency Profile <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                      <li><a href="dashboard/production/emergency_profile.php">Contacts</a></li>
                      <li><a href="dashboard/production/insurance.php">Insurance</a></li>
                      <li><a href="dashboard/production/medcard.php">Medical Card</a></li>
                  ...
                  <li><a><i class="fa fa-calendar"></i> Appointments <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dashboard/production/physician_info.php">Find a physician</a></li>
                      <li><a href="dashboard/production/appointment_list.php">Appointment List</a></li>
                  ...
                  <li><a><i class="fa fa-calculator"></i> Health Calculators <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dashboard/production/health_cal.php">Health Calculators</a></li>
            ...
            <div class="sidebar-footer hidden-small">
              <a data-toggle="tooltip" data-placement="top" title="Settings" href="dashboard/production/settings.php">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="dashboard/production/SignupSignin/signin.php">
                ...
                <ul class=" navbar-right">
                  <li class="nav-item dropdown open" style="padding-left: 15px;">
                    ...
                    <a class="dropdown-item"  href="javascript:;">Help</a>
                      <a class="dropdown-item"  href="dashboard/production/SignupSignin/signin.php"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                    </div>
                  </li>

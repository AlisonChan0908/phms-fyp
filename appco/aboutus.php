                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-6">
                        <div class="section-tittle text-center">
                            <h2>How Can We Help You<br>with PHMS!</h2>
                        </div>
                    </div>
                </div>
                <!-- Section caption -->
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="services-caption active text-center mb-30">
                            ...
                            <div class="service-cap">
                                <h4><a href="#">Track your Records</a></h4>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="services-caption text-center mb-30">
                            ...
                            <div class="service-cap">
                                <h4><a href="#">Upload Documents</a></h4>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="services-caption text-center mb-30">
                            ...
                            <div class="service-cap">
                                <h4><a href="#">Easy Sharing</a></h4>
                                <p>Share your health records to your doctors now.</p>
                            </div>
                        </div>
                    </div>
                </div>
